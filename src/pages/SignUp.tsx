  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      toast({
        ...
        description: "Welcome to Aurora AI Platform"
      });
    }
  };
      ...
      <div className="relative z-10 w-full max-w-md">
        <Card className="glass-card border-white/10">
          <CardHeader className="text-center space-y-2">
            ...
            <CardTitle className="text-2xl font-bold text-white geist-font">Create Account</CardTitle>
            <CardDescription className="text-gray-300 inter-font">
              Join Aurora AI Platform today
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="fullName" className="text-white/90 inter-font">Full Name</Label>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-1 text-xs">
                      {Object.entries(passwordStrength).map(([key, met]) => (
                        <div key={key} className={`flex items-center gap-2 ${met ? "text-green-400" : "text-gray-400"}`}>
